...
const Multi = () => {
  ...
  useEffect(() => {
    ...
    stompClient.onConnect = () => {
      ...
      stompClient.publish({ destination: "/app/enter", body: JSON.stringify({ roomId: 1, writer: uid, message: `${uid}님이 입장하셨습니다.` }) });
    };
  ...
  const handleMessageSend = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    client.publish({ destination: "/app/chat", body: JSON.stringify({ roomId: 1, writer: uid, message: input }) });
    setInput("");
  };
